    ...
    >
      ...
      <div className="deznav-scroll">
                    ...
                    <>
                      ...
                      <Collapse in={state.active === data.title ? true : false}>
                        <ul className={`${menuClass === "mm-collapse" ? "mm-show" : ""}`}>
                          <li className="menu-heading ps-3 mt-2 mb-1 text-black fw-bold fs-6 text-uppercase">
                            --- {data.title} ---
                          </li>
        ...
        <div className="copyright">
          <p><strong>Ventic Ticketing Dashboard</strong> © {date.getFullYear()} All Rights Reserved</p>

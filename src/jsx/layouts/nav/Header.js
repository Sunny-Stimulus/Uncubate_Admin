...
import logo from '../../../images/uncubate-logo.png';
            ...
            <ul className="navbar-nav header-right main-notification">
              ...
              >
                ...
                >
                  ...
                  <span className="badge light text-white bg-secondary rounded-circle">5</span>
                </Dropdown.Toggle>
              </Dropdown>
              ...
              {/* <Dropdown as="li" className="nav-item dropdown notification_dropdown ">
                <Dropdown.Toggle
                  className="nav-link i-false c-pointer ai-icon" variant="" as="a"
                ...
                >
                  ...
                  <span className="badge light text-white bg-secondary rounded-circle">2</span>
                </Dropdown.Toggle>
              ...
              {/* <Dropdown as="li" className="nav-item  notification_dropdown ">
                <Dropdown.Toggle as="div" className="form-control language-btn i-false ">
                  {country}
                  <i className="fa fa-caret-down ms-2"></i>
                </Dropdown.Toggle>
                <Dropdown.Menu >
                  <Dropdown.Item onClick={() => setCountry("FRANCE")}>FRANCE</Dropdown.Item>
                  <Dropdown.Item onClick={() => setCountry("CANADA")}>CANADA</Dropdown.Item>
                  <Dropdown.Item onClick={() => setCountry("GERMAN")}>GERMAN</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown> */}
              ...
              <Dropdown as="li" className="nav-item dropdown header-profile">
                ...
                >
                  <div className="header-info me-3">
                    <span className="fs-16 font-w600 ">Uncubate.Co</span>
                    <small className="text-end fs-14 font-w400">Super Admin</small>
                  </div>
                  <img src={logo} width={20} alt="" style={{background:'#333'}} />
                </Dropdown.Toggle>
